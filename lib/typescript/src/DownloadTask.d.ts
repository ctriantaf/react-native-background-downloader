import { type BeginHandler, type BeginHandlerObject, type DoneHandler, type DoneHandlerObject, type ErrorHandler, type ErrorHandlerObject, type ProgressHandler, type ProgressHandlerObject, type TaskInfo, type CancelHandler, type CancelHandlerObject } from './index.d';
export default class DownloadTask {
    ...
    cancelHandler: CancelHandler | undefined;
    ...
    cancel(handler: CancelHandler): this;
    ...
    onCancel(params: CancelHandlerObject): void;
    pause(): void;
    resume(): void;
    stop(): void;
